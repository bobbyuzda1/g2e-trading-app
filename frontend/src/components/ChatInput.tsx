    ...
    <form onSubmit={handleSubmit} className="flex items-end gap-2">
      <div className="flex-1 relative">
        <textarea
          ...
          disabled={disabled}
          rows={1}
          className={`w-full resize-none rounded-lg border px-4 py-2 pr-12 focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500 disabled:cursor-not-allowed ${
            theme === 'dark'
              ? 'bg-slate-700 border-slate-600 text-gray-200 placeholder-gray-400 disabled:bg-slate-800'
